  ...
  [ "TWS API v9.72+", "index.html", [
    ...
    [ "Using Third Party API Platforms", "third_party.html", [
      [ "Frequently Asked Questions", "third_party.html#third_party_faq", [
        ...
        [ "Is there a fee involved to receive data from the API?", "third_party.html#fees", null ],
        [ "Can the TWS API be used with trial accounts?", "third_party.html#trial_accounts", null ],
        [ "What types of APIs are available?", "third_party.html#apis_available", null ],
        [ "What are differences between connecting to the TWS API and using a FIX/CTCI connection?", "third_party.html#api_vs_fix", null ],
        [ "Can I use another trading application (IBKR mobile, WebTrader, TWS) while an API program is connected?", "third_party.html#multiple_trading_applications", null ],
        [ "Can the TWS API be used with any IB account?", "third_party.html#eligible_accounts", null ],
        [ "Why does an order from the API appear as untransmitted in TWS with a 'T' button next to it?", "third_party.html#untransmitted_orders", null ],
        [ "Is autolaunching of TWS or IB Gateway supported by IB?", "third_party.html#autolaunching", null ],
        [ "Is it possible to disable the daily auto-logoff requirement of TWS?", "third_party.html#autoshutdown_requirement", null ],
        [ "Do you recommend any third party products or programming consultants?", "third_party.html#programming_consultants", null ],
        [ "What are the differences between using an API application with TWS and IB Gateway?", "third_party.html#tws_vs_ibg", null ],
        [ "Is it possible to run TWS or IB Gateway on a headless server?", "third_party.html#gui_requirement", null ],
        [ "Do I ever need to upgrade the TWS API?", "third_party.html#upgrading", null ],
        [ "The data indicator in IB Gateway is red. Is something wrong?", "third_party.html#red_data_indicator", null ],
        [ "How do I report a problem to the API Support team?", "third_party.html#reporting_problem", null ],
        [ "Are historical account positions or account values available from the TWS API?", "third_party.html#historical_positions", null ],
        [ "Does IB provide hosting services for custom algorithms?", "third_party.html#web_hosting", null ],
        [ "Is there an Excel API for MacOS?", "third_party.html#excel_windows", null ]
      ] ]
    ] ],
...
"classIBApi_1_1Order.html#ac8d2e2d8240ec305f5a02deef3808f0f",

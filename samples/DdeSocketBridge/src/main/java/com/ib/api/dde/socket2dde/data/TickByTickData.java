...
public class TickByTickData {
    ...
    private Decimal m_size = Decimal.INVALID; // AllLast
    ...
    private Decimal m_bidSize = Decimal.INVALID; // BidAsk
    private Decimal m_askSize = Decimal.INVALID; // BidAsk
    ...
    public Decimal bidSize()                   { return m_bidSize; }
    public Decimal askSize()                   { return m_askSize; }
    ...
    public TickByTickData(long time, double price, Decimal size, TickAttribLast tickAttribLast,
    ...
    public TickByTickData(long time, double price, Decimal size) {
    ...
    public TickByTickData(long time, double bidPrice, double askPrice, Decimal bidSize, Decimal askSize,
    ...
    public void setBidAskData(double bidPrice, double askPrice, Decimal bidSize, Decimal askSize,
            TickAttribBidAsk tickAttribBidAsk) {
        m_bidPrice = bidPrice;
        m_askPrice = askPrice;
        m_bidSize = bidSize;
    ...
    public void setLastData(double price, Decimal size, TickAttribLast tickAttribLast,
            String exchange, String specialConditions) {
        m_price = price;
        m_size = size;
        m_tickAttribLast = tickAttribLast;

...
public abstract class DDEServer
{
     ...
     * @throws com.pretty_tools.dde.DDEException
     */
    public void notifyClients(String topic, String item) throws DDEException
    {
        checkState();
    ...
    private native void nativeNotifyClients(String topic, String item) throws UnsatisfiedLinkError, DDEException;
